<?php
$pagename = 'House Loan Application';
@include('head.php');
?>
...
<?include('../parts/loginbody.php');?>
	<h2>Loan (House) Application Form</h2>

	<form method="post" action="" id="contactform">
	<fieldset>
		<legend>Loan Purpose</legend>
		<table>
		  <tr>
		  ...
		  <tr>
			...
			<td class="input"><input name="propertyadr" value = "" maxlength="30" size="20" class="required" /></td>
		  </tr>
		  <tr>
			<td class="label">*Selling Price:</td>
			<td class="input"><input name="propertyprice" value = "" maxlength="30" size="20" class="required" /></td>
		  </tr>
		</table>
	</fieldset>
<br />
...
<table>
	...
	<input id="email" name="email" maxlength="40" size="30" class="required email" /></td></tr>
	<tr><td><label>Fax Number:</label></td><td>
	<input name="fax" maxlength="20" size="30" /></td></tr>
	<tr><td><label>*Cellular Phone Number:</label></td><td>
	<input name="celphone" maxlength="20" size="30" class="required" /></td></tr>
	...
	<tr><td><label class="small">&nbsp;&nbsp;&nbsp;Street:</label></td><td>
	<textarea name="bstreet"  value = "" maxlength="100" rows="2" cols="30"  class="required"></textarea></td></tr>
	<tr><td><label class="small">&nbsp;&nbsp;&nbsp;City:</label></td><td>
	<input name="bcity" value = "" maxlength="30" size="30"  class="required" /></td></tr>
	<tr><td><label class="small">&nbsp;&nbsp;&nbsp;Province:</label></td><td>
...
<br />
	<fieldset>
	<legend>Referral Information (fillup applicable information)</legend>

	<table>
	
		<tr>
			<td class="label">Broker/Developer:</td>
			<td class="input"><input id="brokername" name="brokername" maxlength="50" size="30" /></td>
		</tr>
		<tr>
			<td class="label">Bank Branch:</td>
			<td class="input"><input id="branchname" name="branchname" maxlength="50" size="30" /></td>
		</tr>
	</table>
	</fieldset>
<br />
