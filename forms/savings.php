<?php
$pagename = 'Savings Account Application';
@include('head.php');
...
<?include('../parts/loginbody.php');?>
	<h2>Savings/ATM Account Application Form</h2>

	<form method="post" action="savingsinsert.php" id="contactform">
	<fieldset>
	...
	<input id="email" name="email" maxlength="40" size="20" class="required email" />
<img id="tick2" src="../images/tick.png" width="16" height="16"/>
<img id="cross2" src="../images/cross.png" width="16" height="16"/>
	<br /><span class="email_val validation"></span></td></tr>
...
<legend>Please provide following details<br />only if you have been<br />referred by an employee of the Bank:</legend>
  <table>
	...
	<input name="refBranch" value = "" maxlength="30" size="20" /></td></tr>
	<tr><td><label>Branch Code/Foreign Office Code:</label></td><td>
	<input name="refBranchCode" value = "" maxlength="5" /></td></tr>
	<tr><td><label>Name of Referring Employee:</label></td><td>
	<input name ="refemployee" maxlength="30" value = "" size="20" /></td></tr>
  </table>
</fieldset>
...
<fieldset>
  ...
  <table>
    <tr>
      <td>*Username:</td>
      <td><input name="uname" id="username" size="20" class="required" />
<img id="tick" src="../images/tick.png" width="16" height="16"/>
<img id="cross" src="../images/cross.png" width="16" height="16"/></td>
    </tr>
    <tr>
      <td width="220px">*Password:</td>
      <td><input type="password" id="password" name="pword" size="20" class="required" /></td>
    </tr>
  </table>
</fieldset>
